...
mod tests {
    ...
    macro_rules! test_encode {
        ($fn:ident, $code:path, $parity:expr) => {
            #[test]
            fn $fn() {
                let code = $code;
                let parity = $parity;
    ...
    test_encode!(test_encode_tc128, LDPCCode::TC128,
                 [0x34, 0x99, 0x98, 0x87, 0x94, 0xE1, 0x62, 0x56]);

    test_encode!(test_encode_tc256, LDPCCode::TC256,
                 [0x8C, 0x99, 0x21, 0x34, 0xAD, 0xB0, 0xCF, 0xD2,
                  0x2D, 0xA5, 0xF7, 0x7F, 0xBB, 0x42, 0x34, 0xCD]);

    test_encode!(test_encode_tc512, LDPCCode::TC512,
    ...
    test_encode!(test_encode_tm1280, LDPCCode::TM1280,
    ...
    test_encode!(test_encode_tm1536, LDPCCode::TM1536,
    ...
    test_encode!(test_encode_tm2048, LDPCCode::TM2048,
    ...
    test_encode!(test_encode_tm5120, LDPCCode::TM5120,
    ...
    test_encode!(test_encode_tm6144, LDPCCode::TM6144,
    ...
    test_encode!(test_encode_tm8192, LDPCCode::TM8192,
